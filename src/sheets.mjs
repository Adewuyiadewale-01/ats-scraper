...
const defaultControl = [
  ...
  ["Minimum Page Delay (ms)", "2000", "Minimum spacing before advancing a Google results page."],
  ["Maximum Page Delay (ms)", "5000", "Maximum spacing before advancing a Google results page."],
  ["Minimum Inter-query Delay (ms)", "30000", "Minimum spacing between completed Google queries."],
  ["Maximum Inter-query Delay (ms)", "90000", "Maximum spacing between completed Google queries."],
  ["Query Burst Size", "10", "Complete this many full queries before a longer cooldown."],
  ["Minimum Cooldown (ms)", "300000", "Shortest pause between query bursts (5 minutes)."],
  ["Maximum Cooldown (ms)", "600000", "Longest pause between query bursts (10 minutes)."],
  ["Maximum Pages Per Query", "20", "Safety limit; reaching it pauses the query for review instead of marking it complete."],
  ["Maximum Search Minutes Per Query", "20", "Safety time limit for a single Google query."],
